...
if (onPage==100){
  ...
  new Audio("https://www.mikmaqonline.org/words-mp3/media/n/najiwsget/recording1.mp3").play()
...
if (onPage==100){
  cp1=2;
  new Audio("https://www.mikmaqonline.org/words-mp3/media/g/getantoq/recording1.mp3").play()
  pagePull();
  }
  else if(onPage==200){
  cp2=2;
...
if (onPage==100){
  cp1=3;
  new Audio("https://www.mikmaqonline.org/words-mp3/media/g/getanatl/recording1.mp3").play()
  pagePull();
  }
  else if(onPage==200){
  cp2=3;
