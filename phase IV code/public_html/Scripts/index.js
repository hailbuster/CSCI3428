...
var SERVER_URL = "http://stud.cs.smu.ca:3707";
...
//For the images rotation in the end page
var endImages;
...
function getSelect1() {
    ...
    if (onPage == 100) {
        ...
        new Audio(
            "https://ugdev.cs.smu.ca/~group17/Audio_MP3/Chapter1/page1/p1_opt1.mp3"
        ).play();
        ...
        cp2 = 1;
        new Audio(
            "https://ugdev.cs.smu.ca/~group17/Audio_MP3/Chapter1/page2/p2_opt1.mp3"
        ).play();
        pagePull();
    } else if (onPage == 300) {
        cp3 = 1;
        new Audio(
            "https://ugdev.cs.smu.ca/~group17/Audio_MP3/Chapter1/page3/p3_opt1.mp3"
        ).play();
        pagePull();
    } else if (onPage == 400) {
        cp4 = 1;
        new Audio(
            "https://ugdev.cs.smu.ca/~group17/Audio_MP3/Chapter1/page4/p4_opt1.mp3"
        ).play();
        pagePull();
    }
}
...
function getSelect2() {
    ...
    if (onPage == 100) {
        cp1 = 2;
        new Audio(
            "https://ugdev.cs.smu.ca/~group17/Audio_MP3/Chapter1/page1/p1_opt2.mp3"
        ).play();
        pagePull();
    } else if (onPage == 200) {
        cp2 = 2;
        new Audio(
            "https://ugdev.cs.smu.ca/~group17/Audio_MP3/Chapter1/page2/p2_opt2.mp3"
        ).play();
        pagePull();
    } else if (onPage == 300) {
        cp3 = 2;
        new Audio(
            "https://ugdev.cs.smu.ca/~group17/Audio_MP3/Chapter1/page3/p3_opt2.mp3"
        ).play();
        pagePull();
    } else if (onPage == 400) {
        cp4 = 2;
        new Audio(
            "https://ugdev.cs.smu.ca/~group17/Audio_MP3/Chapter1/page4/p4_opt2.mp3"
        ).play();
        pagePull();
    }
}
...
function getSelect3() {
    ...
    if (onPage == 100) {
        cp1 = 3;
        new Audio(
            "https://ugdev.cs.smu.ca/~group17/Audio_MP3/Chapter1/page1/p1_opt3.mp3"
        ).play();
        pagePull();
    } else if (onPage == 200) {
        cp2 = 3;
        new Audio(
            "https://ugdev.cs.smu.ca/~group17/Audio_MP3/Chapter1/page2/p2_opt3.mp3"
        ).play();
        pagePull();
    } else if (onPage == 300) {
        cp3 = 3;
        new Audio(
            "https://ugdev.cs.smu.ca/~group17/Audio_MP3/Chapter1/page3/p3_opt3.mp3"
        ).play();
        pagePull();
    } else if (onPage == 400) {
        cp4 = 3;
        new Audio(
            "https://ugdev.cs.smu.ca/~group17/Audio_MP3/Chapter1/page4/p4_opt3.mp3"
        ).play();
        pagePull();
    }
}
...
function getValue(options) {
    ...
    if (options == "Muin (Bear)") {
        new Audio(
            "https://www.mikmaqonline.org/words-mp3/media/m/mui'n/recording1.mp3"
        ).play();
    } else if (options == "Tia m (Moose)") {
        new Audio(
            "https://www.mikmaqonline.org/words-mp3/media/t/tia'm/recording1.mp3"
        ).play();
    } else if (options == "Kitpu (Eagle)") {
        new Audio(
            "https://www.mikmaqonline.org/words-mp3/media/g/gitpu/recording1.mp3"
        ).play();
    }
    ...
    if (options == "Give the bear some fish") {
        new Audio(
            "https://www.mikmaqonline.org/words-mp3/media/i/ignmuetoq/recording1.mp3"
        ).play();
    } else if (options == "Go get Help") {
        new Audio(
            "https://www.mikmaqonline.org/words-mp3/media/g/getuapetg/recording1.mp3"
        ).play();
    } else if (options == "Leave it alone") {
        new Audio(
            "https://www.mikmaqonline.org/words-mp3/media/m/maja'sit/recording1.mp3"
        ).play();
    }
    ...
    if (options == "The Truth") {
        new Audio(
            "https://www.mikmaqonline.org/words-mp3/media/g/gegnuimatl/recording1.mp3"
        ).play();
    } else if (options == "Told a big Tale") {
        new Audio(
            "https://www.mikmaqonline.org/words-mp3/media/n/nujinutmaqaniget/recording1.mp3"
        ).play();
    } else if (options == "Lied and said bear stole my fish") {
        new Audio(
            "https://www.mikmaqonline.org/words-mp3/media/e/egsuo'qon/recording1.mp3"
        ).play();
    }
}
...
function englishAlertPg4() {
    alert(
        "I gave the bear 2 fish, and he began to eat. After eating the fish, the bear began to walk away. Looking back the bear nodded its head at me, and I was happy. I went home and told my family..."
    );
}
...
function pagePull() {
    ...
    Simg1.src =
        "http://stud.cs.smu.ca/~jl_boyd/Scripts/images/0" +
        sPic.toString(10) +
        ".jpg";
    //"http://stud.cs.smu.ca:3017/images/Fox.jpg";

    addSummaryImage(endImages, Simg1.src);
    //console.log(endImages);
    ...
    if (SimageId1.hasChildNodes() == true) {
        if (SimageId1.lastElementChild == null) {
    ...
    if (imageId1.hasChildNodes() == true) {
        if (imageId1.lastElementChild == null) {
            imageId1.appendChild(img1);
        } else {
    ...
    if (imageId2.hasChildNodes() == true) {
        if (imageId2.lastElementChild == null) {
            imageId2.appendChild(img2);
        } else {
    ...
    if (imageId3.hasChildNodes() == true) {
        if (imageId3.lastElementChild == null) {
            imageId3.appendChild(img3);
        } else {
...
//Fill the last page elements
function fillLastPage() {
    //Fill the summary  elements (<p>)
    $("#summary").html(
        " The text in this block will be in the Native Mi'kmaw language \
    <br> \
    There will also be an audio reading of the text. \
    <br><br> \
    (Replay) Our story begins down by the river. \
    It is a sunny day and I decided to go to the river \
    to do some <em>fishing.</em> \
    <br> \
    I caught 5 trout. This was enough \
    for my family to have a big feast. Down the river \
    I saw a wounded <em>Bear.</em> \
    <br> \
    I saw that the bear was weak and hungry, \
    so I decided to <em>Give fish.</em> \
    <br> \
    I gave the bear 2 fish, and he began to eat. \
    After eating the fish, the bear began to walk away. \
    Looking back the bear nodded its head at me, and I was happy. \
    I went home and told my family <em> \
        The truth. </em> \
    <br> \
    My family was proud that I helped the wounded bear, \
    but they told me to be careful next time because it \
    may be dangerous to feed wounded animals. \
    I made a new friend that day with the bear and still \
    had enough fish for my family to eat."
    );
}

//Function to add images for the rotation
function addSummaryImage(SummaryImages, imageSrc) {
    let splitted = imageSrc.split("/");
    let imageId = splitted[splitted.length - 1].substring(0, 4);

    //console.log(imageId);

    //This turns to true when item is added
    let valid = false;
    // "http://stud.cs.smu.ca/~jl_boyd/Scripts/images/0"

    let imageIdOther;

    //Look for the images in the array that has the same id
    for (let i = 0; i < SummaryImages.length; i++) {
        splitted = SummaryImages[i].split("/");
        imageIdOther = splitted[splitted.length - 1].substring(0, 4);
        if (
            imageId.substring(0, 2) == imageIdOther.substring(0, 2) &&
            imageIdOther != "0101"
        ) {
            //Remove the id that was previously selected if go back a page
            var filtered = SummaryImages.filter((value) => {
                return (
                    value !=
                    "http://stud.cs.smu.ca/~jl_boyd/Scripts/images/" +
                        imageId +
                        "jpg"
                );
            });
    ...
    if (valid == false) {
        SummaryImages.push(
            "http://stud.cs.smu.ca/~jl_boyd/Scripts/images/" + imageId + ".jpg"
        );
    }
}
...
//Rotate through the end images array
function rotate() {
    var imageObj = document.getElementById("placeholder");
    //console.log(endImages);
    imageObj.src = endImages[imgCounter];
    ++imgCounter;
    if (imgCounter == endImages.length) imgCounter = 0;
}

//Call the rotate function with a certain interval
function startRotation() {
    endImages = [...new Set(endImages)];
    document.getElementById("placeholder").src = endImages[0];
